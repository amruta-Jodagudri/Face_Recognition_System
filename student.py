...
class student:
    def __init__(self,root):
        ...
        dep_combo=ttk.Combobox(currentCourse_frame,font=("times new roman",12,"bold"),state="readonly",width=20)
        ...
        course_combo=ttk.Combobox(currentCourse_frame,font=("times new roman",12,"bold"),state="readonly",width=20)
        ...
        Year_combo=ttk.Combobox(currentCourse_frame,font=("times new roman",12,"bold"),state="readonly",width=20)
        ...
        Semester_combo=ttk.Combobox(currentCourse_frame,font=("times new roman",12,"bold"),state="readonly",width=20)
        ...
        studentid_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        studentname_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        class_div_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        roll_no_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        gender_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        dob_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        email_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        phone_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        address_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        teacher_entry=ttk.Entry(Student_class_frame,width=18,font=("times new roman",12,"bold"))
        ...
        radiobtn2=ttk.Radiobutton(Student_class_frame,text="No Photo Sample",value="Yes")
